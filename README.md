[![React App CI](https://github.com/poojadpatkar96/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/poojadpatkar96/ci-cd-with-actions/actions/workflows/ci.yml)
